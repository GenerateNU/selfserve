...
type Application struct {
	...
	DefaultHotelID string `env:"DEFAULT_HOTEL_ID" envDefault:"a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11"` // TODO: Remove once we have clerk orgs to pull from for hotel IDs
}
