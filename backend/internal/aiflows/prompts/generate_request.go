...
const GenerateRequestPrompt = `
	...
	- Required fields: name, request_type.
	...
	{"name":"Soda Delivery","request_type":"one-time","status":"pending","priority":"normal","room_mentioned":true,"room_reference":"301"}

	Valid example without room mention:
	{"name":"Extra Towels Request","request_type":"one-time","status":"pending","priority":"normal"}
`
