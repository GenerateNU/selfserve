...
type mockRequestRepository struct {
	...
	findRequestsPaginatedFunc          func(ctx context.Context, hotelID, userID string, unassigned bool, status string, priorities []string, departments []string, sort models.RequestFeedSort, cursorID string, cursorCreatedAt time.Time, cursorPriorityRank int, limit int) ([]*models.GuestRequest, error)
}
...
func (m *mockRequestRepository) FindRequestsPaginated(ctx context.Context, hotelID, userID string, unassigned bool, status string, priorities []string, departments []string, sort models.RequestFeedSort, cursorID string, cursorCreatedAt time.Time, cursorPriorityRank int, limit int) ([]*models.GuestRequest, error) {
	return m.findRequestsPaginatedFunc(ctx, hotelID, userID, unassigned, status, priorities, departments, sort, cursorID, cursorCreatedAt, cursorPriorityRank, limit)
}
