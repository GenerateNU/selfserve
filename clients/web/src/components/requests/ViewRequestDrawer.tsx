  ...
  return (
    <DrawerShell title={request.name ?? "Untitled Request"} onClose={onClose}>
      <div className="flex flex-col gap-4">
        ...
        {roomLabel && (
          <FieldRow label="Room" value={roomLabel} />
        )}
        ...
        {request.scheduled_time && (
          <FieldRow label="Scheduled" value={formatDate(request.scheduled_time)} />
        )}
        ...
        {request.completed_at && (
          <FieldRow label="Completed" value={formatDate(request.completed_at)} />
        )}
      </div>
