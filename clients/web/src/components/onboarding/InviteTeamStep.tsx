    ...
    <div className="flex flex-row w-[1371px] h-[982px]">
      ...
      >
        ...
        <div
          ...
          style={{ width: '662.6px', height: '625px', borderRadius: '24px', padding: '48px', gap: '50px' }}
        >
          {/* Header */}
          ...
          {/* Email invite */}
          <div className="flex flex-col gap-2 items-center" style={{ width: '390px' }}>
            ...
            {invited && <p className="text-xs text-green-700 text-center">Invite sent!</p>}
            <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '12px', color: '#62748E', textAlign: 'center' }}>
              You can also do this later from your settings.
            </p>
          </div>

          {/* Actions */}
          <div className="flex flex-col gap-3 items-center" style={{ width: '390.02px' }}>
            <button
