export function LeftPanel() {
  return (
    <div className="relative bg-[var(--color-bg-primary)] shrink-0 w-[36.47vw] h-screen border-r border-[var(--color-text-default)] overflow-hidden">
      <div className="absolute bottom-[11.6vh] left-[9.8%] w-[78.8%] flex flex-col gap-2">
        <span className="font-bold text-2xl leading-8 tracking-[-0.070625rem]">
          SelfServe
        </span>
