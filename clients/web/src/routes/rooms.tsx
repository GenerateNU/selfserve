...
export default function RoomsPage() {
    const [roomFilters, setRoomFilters] = useState<RoomFilters>(initialRoomFilters);
    ...
    return (
        <main className="flex flex-col h-screen overflow-hidden">
            <RoomsHeader roomFilters={roomFilters} onRoomFilterChange={updateRoomFilter} />

            <section className="flex flex-1 min-h-0">
                <RoomsList rooms={rooms} onRoomSelect={setSelectedRoomId} selectedRoomId={selectedRoomId} />
