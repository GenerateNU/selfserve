  ...
  return (
    ...
    >
      <View className="flex-row gap-2 items-stretch">
        {/* Room number badge — square, stretches to match info column height */}
        <View className="bg-card rounded items-center justify-center size-[86px]">
          <Text className="text-xs text-primary text-center">Room</Text>
          <Text className="text-2xl font-medium text-primary leading-tight text-center">
            {roomNumber}
          </Text>
        </View>

        {/* Info column — fixed order: type → status → tags */}
