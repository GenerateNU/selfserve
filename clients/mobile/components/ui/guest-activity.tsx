...
export function GuestActivityTab({
  currentStays,
  pastStays,
  onViewAllBookings,
      ...
      <View className="flex-row items-center gap-[2vw]">
        ...
        <View className="flex-row items-center gap-[1vw]">
          ...
          <Text className="text-[3.5vw] text-primary">
            {fmt(stay.arrival_date)}
          </Text>
        </View>
        <View className="flex-row items-center gap-[1vw]">
          <Clock size={12} color={Colors.light.tabBarActive} />
          <Text className="text-[3.5vw] text-primary">
            {fmtTime(stay.arrival_date)}
          </Text>
        </View>
      </View>
      <View className="flex-row items-center gap-[2vw]">
        ...
        <View className="flex-row items-center gap-[1vw]">
          <Calendar size={12} color={Colors.light.tabBarActive} />
          <Text className="text-[3.5vw] text-primary">
            {fmt(stay.departure_date)}
          </Text>
        </View>
        <View className="flex-row items-center gap-[1vw]">
          <Clock size={12} color={Colors.light.tabBarActive} />
          <Text className="text-[3.5vw] text-primary">
            {fmtTime(stay.departure_date)}
          </Text>
        </View>
      </View>
    </View>
